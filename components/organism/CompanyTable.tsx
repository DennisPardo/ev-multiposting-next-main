...
<>
      ...
      <ul role="list" className="mt-3 divide-y divide-gray-100 border-t border-gray-200">
        {pinnedgetAllCompanies.map((Company) => (
          <li key={Company.id}>
            <a href="#" className="group flex items-center justify-between px-4 py-4 hover:bg-gray-50 sm:px-6">
              <span className="flex items-center space-x-3 truncate">
                <span
                  className={classNames(Company.bgColorClass, 'w-2.5 h-2.5 flex-shrink-0 rounded-full')}
                  aria-hidden="true"
                />
                <span className="truncate text-sm font-medium leading-6">
                  {Company.name} <span className="truncate font-normal text-gray-500">in {Company.name}</span>
                </span>
              </span>
              <ChevronRightIcon
        ...
        <div className="inline-block min-5 border-b border-gray-200 align-middle">
            ...
            <thead>
              <tr className="border-t border-gray-200">
                <th
                  ...
                  scope="col"
                >
                  <span className="lg:pl-2"> Name of Companies</span>
                </th>
                <th
                  className="border-b border-gray-200 bg-gray-50 px-6 py-3 text-left text-sm font-semibold text-gray-900"
                  scope="col"
                ...
                <tr key={Company.id}>
                  <td className="w-full max-w-0 whitespace-nowrap px-6 py-3 text-sm font-medium text-gray-900">
                    <div className="flex items-center space-x-3 lg:pl-2">
                      <div
                        className={classNames(Company.bgColorClass, 'flex-shrink-0 w-2.5 h-2.5 rounded-full')}
                        aria-hidden="true"
                      />
                      <a href="#" className="truncate hover:text-gray-600">
                        <span>
                          {Company.name} <span className="font-normal text-gray-500">in {Company.name}</span>
                        </span>
                      </a>
                    </div>
                  </td>
